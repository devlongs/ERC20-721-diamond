...
//interact with AddGet contract
const addGet =  await ethers.getContractAt("AddGetter", diamond.address)
const inc = await addGet.increment()
const getNum = await addGet.getNum()
